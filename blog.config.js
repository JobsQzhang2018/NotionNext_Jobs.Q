...
const BLOG = {
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '聖域&雅典娜', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://blog.zzc.ac.cn', // 备案查询链接，如果用了萌备等备案请在这里填写
